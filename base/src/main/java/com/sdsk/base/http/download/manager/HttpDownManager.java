package com.sdsk.base.http.download.manager;



import com.sdsk.base.commonutils.NetWorkUtils;
import com.sdsk.base.http.download.DownInfo;
import com.sdsk.base.http.download.DownloadInterceptor;
import com.sdsk.base.http.download.HttpState;
import com.sdsk.base.http.download.ProgressDownSubscriber;
import com.sdsk.base.http.download.exception.HttpTimeException;
import com.sdsk.base.http.download.exception.RetryWhenNetworkException;
...
//        }
        ...
        if (downInfos.contains(info)) {
            ...
            builder.sslSocketFactory(NetWorkUtils.getSSLSocketFactory());
